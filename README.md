...
# Batch audit all CSV files in dataset folder
python check_date.py --all-files
```
...
python strategy_comparison.py --rr 3.0 --export-json benchmark.json --export-csv benchmark.csv
```
